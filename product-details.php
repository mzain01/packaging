...
if (isset($_GET['id'])) {
    ...
    $relatedQuery = $pdo->prepare("SELECT * FROM products WHERE id != :id LIMIT 5"); // Fetch 8 related products
                            ...
                            <div id="reviews" class="tab_pane">
                                <div class="product__reviews">
                                    ...
                                    <div class="reviews__comment--area">
                                        ...
                                        $query = $pdo->prepare("SELECT * FROM productreviews WHERE product_id = :pid AND status = 'approve'");
                                    ...
                                    <div id="writereview" class="reviews__comment--reply__area">
                                        <form method="post" action="#writereview">
                                            ...
                                            <button class="primary__btn text-white" data-hover="Submit" name="submitreview" type="submit">SUBMIT</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
