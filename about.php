...
<main class="main__content_wrapper">
                                ...
                                <ul class="team__social d-flex justify-content-center align-items-center">
                                    <li class="team__social--list">
                                        <a class="team__social--icon" target="_blank" href="https://www.facebook.com">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="7.667" height="15.524"
                                    ...
                                    <li class="team__social--list">
                                        <a class="team__social--icon" target="_blank" href="https://twitter.com">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14.489" height="11.384"
                                    ...
                                    <li class="team__social--list">
                                        <a class="team__social--icon" target="_blank" href="https://www.youtube.com">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14.49" height="10.582"
    ...
    <!-- <section class="testimonial__section testimonial__bg section--padding pt-50">
        <div class="container">
            <div class="section__heading style2 text-center mb-40">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items--thumbnail">
                                <img class="testimonial__items--thumbnail__img"
                                    src="assets/img/other/testimonial-thumb1.webp" alt="testimonial-img">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testimonial__items--thumbnail">
                                <img class="testimonial__items--thumbnail__img"
                                    src="assets/img/other/testimonial-thumb2.webp" alt="testimonial-img">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testimonial__items--thumbnail">
                                <img class="testimonial__items--thumbnail__img"
                                    src="assets/img/other/testimonial-thumb3.webp" alt="testimonial-img">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testimonial__items--thumbnail">
                                <img class="testimonial__items--thumbnail__img"
                                    src="assets/img/other/testimonial-thumb4.webp" alt="testimonial-img">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testimonial__items--thumbnail">
                                <img class="testimonial__items--thumbnail__img"
                                    src="assets/img/other/testimonial-thumb5.webp" alt="testimonial-img">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="testimonial__items--thumbnail">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial__items--content">
                                <p class="testimonial__items--desc">"Lorem ipsum dolor sit amet, consectetur
