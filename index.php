...
include('header.php');
?>
<main class="main__content_wrapper slider__section--bg2">

    <!-- <img src="image.png" alt=""> -->

    <!-- Start slider section -->
    <section class="hero__slider--section  section--padding">
        <div class="container">
                            ...
                            <div class="swiper-slide">
                                <article class="product__card">
                                    ...
                                    <div class="product__card--content">
                                        <h3 class="product__card--title"><a href="product-details.php?id=<?php echo $product['id'] ?>"><?php echo $product['product_name'] ?></a></h3>
                                        <div class="product__card--footer">
                                            <a class="product__card--btn primary__btn" href="product-details.php?id=<?php echo $product['id'] ?>">
    ...
    <!-- <section class="product__section section--padding  pt-0">
        <div class="container">
            <div class="section__heading section__heading--flex border-bottom d-flex justify-content-between mb-30">
                <h2 class="section__heading--maintitle">Custom Printed Boxes <span> for Any Industry</span></h2>
                <p>Custom packaging designed specifically for different industries. Whether it's retail, beauty products, or electronics, we create packaging that matches your industry's style.</p>
    ...
    <section class="product__section section--padding  pt-0">
        <div class="container">
            <div class=" section__heading--flex border-bottom mb-30 ">


                <ul class="nav tab__btn--wrapper justify-content-center mb-5" role="tablist">
                    <?php
                    $query = $pdo->prepare("SELECT * FROM industries limit 5");
                    $query->execute();
                    $allindustries = $query->fetchAll(PDO::FETCH_ASSOC);
                    ?>
                    <!-- All industries tab -->
                    <li class="tab__btn--item" role="presentation">
                        <button class="tab__btn--link costom-tabs active" data-bs-toggle="tab" data-bs-target="#all-industries" type="button" role="tab" aria-selected="true">All Industries
                        </button>
                    </li>
                    ...
                    ?>
                            <li class="tab__btn--item" role="presentation">
                                <button class="tab__btn--link costom-tabs" data-bs-toggle="tab" data-bs-target="#industry-<?php echo $industry['id']; ?>" type="button" role="tab">
                ...
                <div class="product__section--inner">
                    <div class="row row-md-reverse">
                        ...
                        <div class="col-lg">
                            <div class="tab-content" id="nav-tabContent">
                                <!-- All industries tab content -->
                                <div id="all-industries" class="tab-pane fade show active" role="tabpanel">
                                    <div class="product__wrapper">
                                        <div class="row mb--n30">
                                            <?php
                                            ...
                                            if ($allProducts) {
                                                foreach ($allProducts as $product) {
                                            ?>
                                                    <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-50">
                                                        <article class="product__card">
                                                            <div class="product__card--thumbnail">
                                                                <a class="product__card--thumbnail__link display-block" href="product-details.php?id=<?php echo $product['id']; ?>">
                                                            ...
                                                            <div class="product__card--content">
                                                                <h3 class="product__card--title"><a href="product-details.php?id=<?php echo $product['id']; ?>"><?php echo $product['product_name']; ?></a></h3>
                                                                <div class="product__card--footer">
                                                                    <a class="product__card--btn primary__btn" href="product-details.php?id=<?php echo $product['id']; ?>">Order Now</a>
                                                                </div>
                                                            </div>
                                                        </article>
                                                    </div>
                                ...
                                <!-- Dynamic industry-specific tab content -->
                                <?php
                                if ($allindustries) {
                                    foreach ($allindustries as $industry) {
                                ?>
                                        <div id="industry-<?php echo $industry['id']; ?>" class="tab-pane fade" role="tabpanel">
                                            <div class="product__wrapper">
                                                <div class="row mb--n30">
                                                    <?php
                                                    // Fetch products for each specific industry
                                                    $query = $pdo->prepare("SELECT * FROM products WHERE product_industry = ? limit 6");
                                                    $query->execute([$industry['id']]);
                                                    $industryProducts = $query->fetchAll(PDO::FETCH_ASSOC);
                                                    ...
                                                    <?php
                                                        ...
                                                        echo '<p>No products available in this industry.</p>';
                                                    }
                                                    ?>
                                                </div>
                                            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="form-container">
                            ...
                            <form>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <input type="number" class="form-control" placeholder="Quantity 1" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <select class="form-select" required>
    ...
    <section class="product__section section--padding  pt-0">
        <div class="container">
            <div class="section__heading section__heading--flex border-bottom d-flex justify-content-between mb-30">
                ...
                <ul class="nav tab__btn--wrapper" role="tablist" style="    margin-left: 40px;">
                    <!-- <li class="tab__btn--item" role="presentation">
                            <button class="tab__btn--link active" data-bs-toggle="tab" data-bs-target="#recent" type="button" role="tab" aria-selected="true"> FAQs
                            </button>
                        </li> -->
                    <li class="tab__btn--item" role="presentation">
                        <button class="tab__btn--link active" data-bs-toggle="tab" data-bs-target="#faqs" type="button" role="tab" aria-selected="false">
                            FAQs</button>
                    </li>
                    <li class="tab__btn--item" role="presentation">
                        <button class="tab__btn--link" data-bs-toggle="tab" data-bs-target="#description" type="button" role="tab" aria-selected="false">
                            description</button>
                    </li>
                </ul>
            </div>
            <div class="product__section--inner">
                <div class="row row-md-reverse">
                    <div class="col-lg-12">
                        <div class="tab-content" id="nav-tabContent">
                            <div id="faqs" class="tab-pane fade show active" role="tabpanel">
