        ...
        <div class="col-sm-12 col-xl-12">
            <div class="bg-secondary rounded h-100 p-4">
                <div class="d-flex justify-content-between mb-5">
                    ...
                    <a href="addcostumproduct.php"><button class="btn btn-primary">Add Product</button></a>
                </div>
                    ...
                    ?>
                        <tbody>
                            <tr>
                                ...
                                <td><img src="img/custom/<?php echo $product['product_img']; ?>" width="200px" height="200px" alt=""></td>
