...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = $pdo->prepare(" SELECT * from industries where id = :id");
...
<div class="container add-category mt-5">
    <div class="col-sm-12 col-xl-6">
        <div class="bg-secondary rounded h-100 p-4">
            <h6 class="mb-4">EDIT INDUSTRY</h6>
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <button type="submit" name="uptindustry" class="btn btn-primary">Update Industry</button>
            </form>
