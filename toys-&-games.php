                           ...
                           <div class="col-lg-6 col-md-6">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="contact__form--list mb-20">
                                    ...
                                    <input class="contact__form--input" name="email" id="input4" placeholder="Quantity" type="text">
                                </div>
                            </div>
                           <div class="col-lg-6 col-md-6">
                                <div class="contact__form--list mb-20">
                                    <label class="contact__form--label" for="input2">Budget <span class="contact__form--label__star">*</span></label>
                                    <input class="contact__form--input" name="name of product" id="input2" placeholder="Budget" type="text">
                                </div>
                            </div>
                            <div class="col-12">
                ...
                <!-- <div class="contact__info border-radius-5">
                    ...
                    <div class="contact__info--items">
                        ...
                        <div class="contact__info--items__inner d-flex">
                            ...
                            <div class="contact__info--content">
                                <p class="contact__info--content__desc text-white"> <a href="mailto:info@needpackaging.com">info@needpackaging.com</a> <br> <a href="mailto:info@needpackaging.com">info@needpackaging.com</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="contact__info--items">
