...
// Get the search term from the POST request, if provided
                            ...
                            <div class="pagination__area">
                                <nav class="pagination justify-content-center">
                                    <ul class="pagination__wrapper d-flex align-items-center justify-content-center">
                                        <?php
                                        // Build the base URL with the current filters and search term
                                        $query_string = '';
                                        if (isset($_POST['search'])) {
                                            $query_string .= '&search=' . urlencode($_POST['search']);
                                        }

                                        // Debugging: Output the query string to check if it's correct
