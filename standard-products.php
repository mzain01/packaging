...
try {
    ...
    $count_query = "SELECT COUNT(*) FROM standardproduct";
    if ($cat_id) {
        $count_query .= " WHERE product_cat = :cat_id";
    }
    ...
    $query = "SELECT * FROM standardproduct";
    if ($cat_id) {
        $query .= " WHERE product_cat = :cat_id";
    }
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-6 col-6 custom-col mb-30">
                                                        <article class="product__card">
                                                            <div class="product__card--thumbnail">
                                                                <a class="product__card--thumbnail__link display-block" href="standard-product-details.php?id=<?php echo htmlspecialchars($product['id']); ?>">
                                                            ...
                                                            <div class="product__card--content">
                                                                ...
                                                                <h3 class="product__card--title"> <a href="standard-product-details.php?id=<?php echo htmlspecialchars($product['id']); ?>"><?php echo htmlspecialchars($product['product_name']); ?></a></h3>
